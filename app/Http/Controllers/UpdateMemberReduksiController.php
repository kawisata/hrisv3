...
class UpdateMemberReduksiController extends Controller
{
    public function index()
    {
        ...
        //->where('employee_details.status_member', '=', '');
        if ($cari) {
        ...
        return view('MemberReduksi.FrmListUserUpdate', $data);
    ...
    {   
        $blog = EmployeeModel::whereUserId($id)->with('user', 'employeeDetail', 'employee')->first();
