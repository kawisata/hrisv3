...
class SalarySlip extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.salary-slip');
    }
    ...
    public function update()
    {
        ...
        $this->slip = Oncycle::where('user_id', $this->employeeId)
    ...
    public function update1()
    {
        ...
        $this->slip1 = Oncycle::where('user_id', $this->employeeId)
            ->where('month', $this->month)
            ->where('year', $this->year)
            ->first();
    ...
    public function update2()
    {
        ...
        $this->slip2 = Offcycle::where('user_id', $this->employeeId)
            ->where('month', $this->month)
            ->where('year', $this->year)
            ->first();
