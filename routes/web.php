...
Route::prefix('user')->middleware(['auth:sanctum','role:user'])->group(function () {
    ...
    Route::get('families',function () {return view('livewire.user.families');})->name('user.families');
    ...
    Route::get('salary-slip',function () {return view('livewire.salary.index-salary-slip');})->name('user.salary-slip');
    Route::get('info-rekan',function () {return view('livewire.employee.index-info-rekan');})->name('employee.info-rekan');
});

Route::middleware(['auth','role:administrator'])->group(function () {

    Route::get('employees',function () {return view('livewire.admin.index');})->name('admin.employees');
    Route::get('users-address',function () {return view('livewire.admin.index-user-address');})->name('admin.users-address');
    Route::get('users',function () {return view('livewire.admin.index-user');})->name('admin.users');
    Route::get('users-family',function () {return view('livewire.admin.index-user-families');})->name('admin.users-families');
...
Route::prefix('superadmin')->middleware(['auth','role:superadministrator'])->group(function () {
    ...
    Route::get('salaries',function () {return view('livewire.admin.index-monthly-salaries');})->name('admin.salaries');
...
// Route::get('salary-slip/{uuid}', [SalarySlipController::class,'show'])->name('user.salary-slip-document');
// Route::get('salary-slip-offcycle/{uuid}', [SalarySlipController::class,'show1'])->name('user.salary-slip-offcycle');
// Route::get('salary-slip-all/{uuid}/{ttd}', [SalarySlipController::class,'all'])->name('user.salary-slip-all');
