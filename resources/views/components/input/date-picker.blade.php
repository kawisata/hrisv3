<div x-data="datepicker(@entangle($attributes->wire('model')))" class="relative">
    <div class="flex flex-col">
        ...
        <div class="flex rounded-md shadow-sm">
            <span class="inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 dark:bg-gray-500 text-gray-500 sm:text-sm">
            ...
            <input type="text" x-ref="myDatepicker" x-model="value" class="rounded-none rounded-r-md flex-1 form-input transition duration-150 ease-in-out sm:text-sm sm:leading-5">
        </div>
    </div>
</div>
