...
<div class="flex rounded-md shadow-sm">
    @if ($leadingAddOn)
        <span class="inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 dark:bg-gray-500 dark:text-gray-100 text-gray-500 sm:text-sm">
            {{ $leadingAddOn }}
        </span>
    @endif
