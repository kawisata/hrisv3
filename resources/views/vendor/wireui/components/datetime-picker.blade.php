<div x-data="wireui_datetime_picker({
    ...
    <div class="fixed inset-0 z-20 overflow-y-auto md:absolute md:inset-auto md:top-10 md:mt-1 md:right-0"
         x-cloak
         style="display: none;"
         x-show="popover"
         x-on:click.outside="closePicker"
         x-on:keydown.escape.window="handleEscape">
        <div class="flex items-end justify-center min-h-screen md:h-96 md:items-start"
             style="min-height: -webkit-fill-available; min-height: fill-available;">
            <div class="fixed inset-0 bg-secondary-400 bg-opacity-60 transition-opacity md:hidden
            ...
            <div class="w-full rounded-t-md border border-secondary-200 bg-white shadow-lg
                        ...
                        max-h-96 overflow-y-auto p-3 md:w-72 md:rounded-xl"
                 x-show="popover"
                 tabindex="-1"
                 x-transition:enter="ease-out duration-300"
                ...
                <div x-show="tab === 'date'" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="w-full flex items-center justify-center gap-x-2 text-secondary-600 dark:text-secondary-500">
                            ...
                            <input class="w-10 md:w-14 appearance-none p-0 ring-0 border-none focus:ring-0 focus:outline-none dark:bg-secondary-800"
                                   x-model="year"
