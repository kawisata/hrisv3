            ...
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                   ...
                   <!--      <div class="form-group">
                        ...
                        <form action="MemberUpdateReduksi" method="GET">
                              ...
                              @forelse ($blogs as $blog)
                                <tr>
                                    ...
                                    <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('Berkas.destroy', $blog->id) }}" method="POST"> 
                                        <form>
                                          <a href="{{ route('MemberUpdateReduksi.edit', $blog->id) }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition" wire:loading.attr="disabled">UPDATE</a>
