<div>
    <x-card>
        <div class="inline-flex gap-2 ">
            <div class="p-2 border shadow-md flex-grow">
                <p>Upah Pokok Tunjangan Tetap</p>
                <form wire:submit.prevent="saveOncycle">
                    ...
                    <div class="mt-5 sm:mt-6">
                        ...
                        <button class="text-xs ml-3 inline-flex justify-center px-2 py-2 text-white bg-black rounded hover:bg-blue-700" type="submit">import file</button>
                        </span>
