<div class="relative rounded-lg shadow dark:bg-teal-700 bg-gray-200">
    ...
    <form wire:submit.prevent="save">
        <div class="p-4 space-y-2 w-full">
            <x-input label="Nama Para" wire:model="group_name" placeholder="Nama Para" required />
            <x-input label="Email" wire:model.defer="email" placeholder="email" required />
            <x-input label="Nama di Posisi" wire:model.defer="position_name" placeholder="Nama di Posisi" required />
        </div>
