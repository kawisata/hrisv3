...
{{-- header v2 --}}
            ...
            <div class="px-0 py-0 mt-4 text-xs card-body">
                <table class="table p-0 mx-0 my-0 card-body table-bordered table-sm">
                    ...
                    <tr>
                        <td>NIPP / NIP</td><td>{{$oncycle->user_id}}</td>
                        <td>Rekening</td><td>{{$oncycle->bank}} - {{$oncycle->rekening}}</td>
                    </tr>
                    <tr>
                        <td>Jabatan</td><td>{{$oncycle->jabatan}}</td>
                        <td>NPWP</td><td>{{$oncycle->npwp}}</td>
                    </tr>
                </table>
            </div>
                            ...
                            <td class="p-0">
                                ...
                                <table class="table mb-0 border border-black card-body table-sm">
                                    <tbody>
                                            ...
                                            @else
                                            <tr><td>Gaji Direksi</td><td style="text-align:right">{{number_format($oncycle->t_direksi, 0, ',', '.')}}</td></tr>
                                            @endif

                                            @if($oncycle->t_komisaris == 0)
                                            @else
                                            <tr><td>Honorarium Komisaris</td><td style="text-align:right">{{number_format($oncycle->t_direksi, 0, ',', '.')}}</td></tr>
                                            @endif

                                            @if($oncycle->t_transport_komisaris == 0)
                                            @else
                                            ...
                                            @else
                                            <tr><td>-  Tunjangan Perumahan Direksi</td><td style="text-align:right">{{number_format($oncycle->t_perumahan_direksi, 0, ',', '.')}}</td></tr>
                                            @endif

                                            @if($oncycle->perumahan  == 0)
                                            @else
                                            <tr><td>-  Tunjangan Perumahan</td><td style="text-align:right">{{number_format($oncycle->perumahan, 0, ',', '.')}}</td></tr>
                                            @endif
                                            ...
                                            <tr><td>-  Jaminan Kematian 0,3%</td><td style="text-align:right">{{number_format($oncycle->jk, 0, ',', '.')}}</td></tr>
                                            ...
                                            @else
                                            <tr><td>-  JPK BPJS 4%</td><td style="text-align:right">{{number_format($oncycle->jpk_kawis, 0, ',', '.')}}</td></tr>
                                            @endif

                                            @if($oncycle->jpk  == 0)
                                            @else
                                            <tr><td>-  JPK BPJS 4%</td><td style="text-align:right">{{number_format($oncycle->jpk, 0, ',', '.')}}</td></tr>
                                            @endif

                                            @if($oncycle->jpk_pens  == 0)
                                            @else
                                            <tr><td>-  JPK Pensiunan 2%</td><td style="text-align:right">{{number_format($oncycle->jpk_pens, 0, ',', '.')}}</td></tr>
                                            @endif

                                            @if($oncycle->pajak  == 0)
                                            @else
                                            <tr><td>Tunjangan Pajak</td><td style="text-align:right">{{number_format($oncycle->pajak, 0, ',', '.')}}</td></tr>
                                            @endif

                                            @if($oncycle->t_kurang_bayar  == 0)
                                            @else
                                            <tr><td>Tunjangan Kekurangan Bayar</td><td style="text-align:right">{{number_format($oncycle->t_kurang_bayar, 0, ',', '.')}}</td></tr>
                                            @endif
                            ...
                            <td class="p-0">
                                ...
                                <table class="table mb-0 border border-black card-body table-sm">
                                    <tbody>
                                        ...
                                        <tr><td>-  Jaminan Kematian BPJS 0,3%</td><td style="text-align:right">{{number_format($oncycle->jk, 0, ',', '.')}}</td></tr>
                                        ...
                                        @if($oncycle->spka == 0)
                                        @else
                                        <tr><td>Potongan Iuran SPKA</td><td style="text-align:right">{{number_format($oncycle->spka, 0, ',', '.')}}</td></tr>
                                        @endif

                                        @if($oncycle->sewa_rumah_dinas == 0)
                                        @else
                                        <tr><td>Potongan Sewa Rumah Dinas</td><td style="text-align:right">{{number_format($oncycle->sewa_rumah_dinas, 0, ',', '.')}}</td></tr>
                                        @endif

                                        @if($oncycle->sewa_mess == 0)
                                        @else
                                        <tr><td>Potongan Sewa Rumah Dinas</td><td style="text-align:right">{{number_format($oncycle->sewa_mess, 0, ',', '.')}}</td></tr>
                                        @endif

                                        @if($oncycle->simp_baituridho == 0)
                                        @else
                                        <tr><td>Potongan Simpanan Baitul Ridho</td><td style="text-align:right">{{number_format($oncycle->simp_baituridho, 0, ',', '.')}}</td></tr>
                                        @endif

                                        @if($oncycle->cic_baituridho == 0)
                                        @else
                                        <tr><td>Potongan Cicilan Baitul Ridho</td><td style="text-align:right">{{number_format($oncycle->cic_baituridho, 0, ',', '.')}}</td></tr>
                                        @endif

                                        @if($oncycle->pajak == 0)
                                        @else
                                        <tr><td>Potongan Pajak</td><td style="text-align:right">{{number_format($oncycle->pajak, 0, ',', '.')}}</td></tr>
                                        @endif


                                        @if($oncycle->potongan_lain == 0)
                                        @else
                                        <tr><td>Potongan Lain-lain</td><td style="text-align:right">{{number_format($oncycle->potongan_lain, 0, ',', '.')}}</td></tr>                                            </tbody>
                                        @endif

                                        @if($offcycle)
                                            @if($offcycle->potongan_lain == 0)
                                            @else
                                            <tr><td>Potongan Lain-lain</td><td style="text-align:right">{{number_format($offcycle->potongan_lain, 0, ',', '.')}}</td></tr>
                                            @endif

                                            @if($oncycle->admin_bank == 0)
                                            @else
                                            <tr><td>Admin Bank Upah Pokok & Tunjangan Tetap</td><td style="text-align:right">{{number_format($oncycle->admin_bank, 0, ',', '.')}}</td></tr>
                                            @endif

                                            @if($offcycle->admin_bank == 0)
                                            @else
                                            <tr><td>Admin Bank Tunjangan Tidak Tetap</td><td style="text-align:right">{{number_format($offcycle->admin_bank, 0, ',', '.')}}</td></tr>
                                            @endif
                                        @endif
