...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css"></link>
          ...
          <ul>
            @role('user')
                ...
                <li class="relative px-6 py-3">
                    <span class="">
                                <x-jet-nav-link href="{{ route('user.salary-slip') }}" :active="request()->routeIs('user.salary-slip')">
                                    <svg
                                    class="w-5 h-5"
                                    aria-hidden="true"
                                    fill="none"
...
<li class="relative px-6 py-3">
									<span class="">
										<x-jet-nav-link href="{{ route('event.presences') }}" :active="request()->routeIs('event.presences')">
            ...
            <li class="relative px-6 py-3">
              ...
              >
                <span class="inline-flex items-center">
                  ...
                  <span class="ml-4">Administrasi Pekerja</span>
                </span>
                <svg
                  class="w-4 h-4"
                  aria-hidden="true"
              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  ...
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                      >
                  <a class="w-full" href="{{ route('MemberReduksiFrontlinerUpdate.index') }}">Import Excel Member Reduksi Frontliner</a> 
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                      >
